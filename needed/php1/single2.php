				...
				<div class="navbar-header">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					  <ul class="nav navbar-nav">
						...
						<li class="active"><a href="blog1.php">Blog</a></li>
			...
			<h3>3 Comments</h3>
				<div class="media">
				  ...
				  <div class="media-body">
					<h4 class="media-heading"><a href="#">Richard </a></h4>
						<p>Hello!</p>
				  </div>
				</div>
				<div class="media in-media">
				  <div class="media-left">
				   ...
				   <div class="media-body">
					<h4 class="media-heading"><a href="#">Jason</a></h4>
						<p>Hello!</p>
				  </div>
				</div>
				<div class="media">
				  ...
				  <div class="media-body">
					<h4 class="media-heading"><a href="#">Eric</a></h4>
						<p>1234</p>
				  </div>
				</div>
			<div class="clearfix"> </div>
            ...
            <div class="contact-main">
				...
				<form>
						...
						<textarea cols="77" rows="6" value=" " onfocus="this.value='';" onblur="if (this.value == '') {this.value = 'Message';}">Message</textarea>
							...
							<input type="reset" value="Send"onClick="location.href='Login.php';" >
